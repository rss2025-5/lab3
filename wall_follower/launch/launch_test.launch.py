...
#     # -------------------------------------------------------------------------
#     # COMMENT OUT or REMOVE all definitions for test1..test5
#     # -------------------------------------------------------------------------
#     # test1 = Node(...test1...)
#     # test2 = Node(...test2...)
#     # test3 = Node(...test3...)
...
#                 "drive_topic": "/drive",
#                 "pose_topic": "/pose",
#                 "velocity": 3.0,                # Make sure velocity=3
#                 "desired_distance": 0.72,      # from your original test6
#                 "side": 1,                     # side=1, i.e. following left wall
#                 "start_x": -7.,
#                 "start_y": 10.6,
#                 "start_z": 0.,
#                 "end_x": -4.,
...
#     # -------------------------------------------------------------------------
#     # DEFINE the wall_follower node with the correct side=1, velocity=3, distance=0.72
#     # so no param-set commands are needed
#     # -------------------------------------------------------------------------
#     wall_follower = Node(
#         package="wall_follower",
#         executable="wall_follower",
...
#                 "scan_topic": "/scan",
#                 "drive_topic": "/drive",
#                 "velocity": 3.0,          # set to 3.0
#                 "desired_distance": 0.72, # same as test6
#                 "side": 1                 # same as test6
#             }
#         ],
#         name='wall_follower',
#         remappings=[
...
#     # -------------------------------------------------------------------------
#     # COMMENT OUT or REMOVE all param-setting actions for tests 1..5
#     # and their OnProcessExit event handlers
#     # -------------------------------------------------------------------------
#     # No more setup_side2_1, etc. or OnProcessExit(test1 => test2)...

#     # -------------------------------------------------------------------------
#     # Now we only launch test6 and the wall_follower node, with no chaining
#     # -------------------------------------------------------------------------
#     return LaunchDescription([
#         LogInfo(msg='Launching only Test 6 with velocity=3, side=1'),
#         # Start the wall_follower node
#         wall_follower,
#         # Start test6 node
#         test6
#     ])
